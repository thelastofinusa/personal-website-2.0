    ...
    <div className="overflow-x-auto">
      ...
      >
        <div className="flex items-center gap-2 border-b border-border/50 px-3 py-1">
          <ActiveIcon className="text-code size-4" />
            ...
            {Object.entries(tabs).map(([key]) => {
              return (
                <TabsTrigger
                  key={key}
                  value={key}
                  className="h-6.5 border border-transparent pt-0.5 text-xs shadow-none! data-[state=active]:border-input data-[state=active]:bg-background!"
                >
                  {key}
                </TabsTrigger>
              )
