  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[--elastic-slider-bg:var(--accent)]",
        "[--elastic-slider-fill:var(--accent-foreground)]/10",
        "[--elastic-slider-fill-active:var(--accent-foreground)]/20",
        "[--elastic-slider-hash:var(--accent-foreground)]/30",
        "[--elastic-slider-handle:var(--foreground)]",
        "[--elastic-slider-label:var(--accent-foreground)]",
